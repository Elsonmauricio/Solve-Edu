...
function e(e2, t2) {
  ...
  if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
    var i2 = 0;
    for (o2 = Object.getOwnPropertySymbols(e2); i2 < o2.length; i2++)
      t2.indexOf(o2[i2]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, o2[i2]) && (n2[o2[i2]] = e2[o2[i2]]);
  }
  return n2;
}
    ...
    function a3(r4) {
      return function(a4) {
        return function(r5) {
          ...
          for (; s3; )
            try {
              if (n3 = 1, o3 && (i2 = 2 & r5[0] ? o3.return : r5[0] ? o3.throw || ((i2 = o3.return) && i2.call(o3), 0) : o3.next) && !(i2 = i2.call(o3, r5[1])).done)
                return i2;
...
var a = { name: "auth0-spa-js", version: "2.9.0" };
var c = () => Date.now();
...
function z(e2) {
  if ("number" != typeof e2.modulusLength || e2.modulusLength < 2048)
    throw new A(`${e2.name} modulusLength must be at least 2048 bits`);
}
async function E(e2, t2, n2) {
  if (false === n2.usages.includes("sign"))
...
if (Uint8Array.prototype.toBase64)
  N = (e2) => (e2 instanceof ArrayBuffer && (e2 = new Uint8Array(e2)), e2.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e2 = 32768;
  N = (t2) => {
    t2 instanceof ArrayBuffer && (t2 = new Uint8Array(t2));
    const n2 = [];
    for (let o2 = 0; o2 < t2.byteLength; o2 += e2)
      n2.push(String.fromCharCode.apply(null, t2.subarray(o2, o2 + e2)));
...
function U(e2) {
  switch (e2.algorithm.name) {
    case "RSA-PSS":
      return function(e3) {
        if ("SHA-256" === e3.algorithm.hash.name)
          return "PS256";
    ...
    case "ECDSA":
      return function(e3) {
        if ("P-256" === e3.algorithm.namedCurve)
          return "ES256";
...
async function H(e2, t2, n2, o2, i2, r2) {
  ...
  if (void 0 !== r2 && ("object" != typeof r2 || null === r2 || Array.isArray(r2)))
...
async function B(t2, n2, o2, i2, r2, s2, a2, c2, d2, h2) {
  ...
  if (d2 && (S2 = v2["dpop-nonce"], S2 && await d2.setNonce(S2)), !_2) {
    ...
    if ("mfa_required" === y2)
      throw new f(y2, e2, k2.mfa_token);
    if ("missing_refresh_token" === y2)
      throw new g(o2, i2);
...
var ie = class {
  ...
  async get(e2, t2 = 0, n2 = false, o2) {
    ...
    if (!r2) {
      ...
      if (i3 && (r2 = await this.cache.get(i3)), !i3 && n2 && "cache-only" !== o2)
        return this.getEntryWithRefreshToken(e2, t3);
    }
    if (!r2)
      return;
  ...
  async getEntryWithRefreshToken(e2, t2) {
    ...
    for (const o2 of t2) {
      ...
      if ("@@auth0spajs@@" === t3.prefix && t3.clientId === e2.clientId) {
        ...
        if (null === (n2 = null == t4 ? void 0 : t4.body) || void 0 === n2 ? void 0 : n2.refresh_token)
          return this.modifiedCachedEntry(t4, e2);
      }
    }
  }
...
var ce = (e2) => {
  ...
  if (e2.max_age && !se(t2.claims.auth_time))
    throw new Error("Authentication Time (auth_time) claim must be a number present in the ID token when Max Age (max_age) is specified");
  if (null == t2.claims.exp || !se(t2.claims.exp))
    throw new Error("Expiration Time (exp) claim must be a number present in the ID token");
  if (!se(t2.claims.iat))
    throw new Error("Issued At (iat) claim must be a number present in the ID token");
  const n2 = e2.leeway || 60, o2 = new Date(e2.now || Date.now()), i2 = /* @__PURE__ */ new Date(0);
  if (i2.setUTCSeconds(t2.claims.exp + n2), o2 > i2)
    throw new Error(`Expiration Time (exp) claim error in the ID token; current time (${o2}) is after expiration time (${i2})`);
  if (null != t2.claims.nbf && se(t2.claims.nbf)) {
    const e3 = /* @__PURE__ */ new Date(0);
    if (e3.setUTCSeconds(t2.claims.nbf - n2), o2 < e3)
  ...
  if (null != t2.claims.auth_time && se(t2.claims.auth_time)) {
    ...
    if (i3.setUTCSeconds(parseInt(t2.claims.auth_time) + e2.max_age + n2), o2 > i3)
      throw new Error(`Authentication Time (auth_time) claim in the ID token indicates that too much time has passed since the last end-user authentication. Current time (${o2}) is after last auth at ${i3}`);
  }
  if (e2.organization) {
...
var ue = o(function(e2, n2) {
  var o2 = t && t.__assign || function() {
    return o2 = Object.assign || function(e3) {
      for (var t2, n3 = 1, o3 = arguments.length; n3 < o3; n3++)
        for (var i3 in t2 = arguments[n3])
          Object.prototype.hasOwnProperty.call(t2, i3) && (e3[i3] = t2[i3]);
      return e3;
...
function we(e2, t2, n2) {
  var o2 = void 0 === t2 ? null : t2, i2 = function(e3, t3) {
    var n3 = atob(e3);
    if (t3) {
      for (var o3 = new Uint8Array(n3.length), i3 = 0, r3 = n3.length; i3 < r3; ++i3)
        o3[i3] = n3.charCodeAt(i3);
...
var Ne = class {
  ...
  buildUrl(e2, t2) {
    if (t2) {
      if (this.isAbsoluteUrl(t2))
        return t2;
      if (e2)
        return `${e2.replace(/\/?\/$/, "")}/${t2.replace(/^\/+/, "")}`;
    }
  ...
  async handleResponse(e2, t2) {
    ...
    if (n2 && await this.hooks.setDpopNonce(n2), !this.hasUseDpopNonceError(e2))
      return e2;
    if (!n2 || !t2.onUseDpopNonceError)
      throw new w(n2);
...
var Ue = class {
  constructor(e2) {
    ...
    if (this.userCache = new oe().enclosedCache, this.activeLockKeys = /* @__PURE__ */ new Set(), this.defaultOptions = { authorizationParams: { scope: "openid profile email" }, useRefreshTokensFallback: false, useFormData: true }, this._releaseLockOnPageHide = async () => {
      ...
      if (t2 = e2.cacheLocation || "memory", !Oe(t2))
    ...
    const i2 = await ((e3) => new Promise((t3, n3) => {
      ...
      o3 = function(s2) {
        if (s2.data && "authorization_response" === s2.data.type) {
          if (clearTimeout(r3), clearInterval(i3), window.removeEventListener("message", o3, false), e3.popup.close(), s2.data.response.error)
            return n3(u.fromPayload(s2.data.response));
          t3(s2.data.response);
        }
  ...
  async _handleLoginRedirectCallback(e2, t2) {
    ...
    if (i2)
      throw new d(i2, r2 || i2, o2, t2.appState);
    if (!t2.code_verifier || t2.state && t2.state !== o2)
      throw new u("state_mismatch", "Invalid state");
  ...
  async _handleConnectAccountRedirectCallback(e2, t2) {
    ...
    if (i2)
      throw new h(i2, r2 || i2, t2.connection, o2, t2.appState);
    if (!n2)
      throw new u("missing_connect_code", "Missing connect code");
    if (!(t2.code_verifier && t2.state && t2.auth_session && t2.redirect_uri && t2.state === o2))
      throw new u("state_mismatch", "Invalid state");
  ...
  async connectAccountWithRedirect(e2) {
    ...
    const a2 = _(v()), c2 = v(), u2 = await T(c2), d2 = j(u2), { connect_uri: h2, connect_params: l2, auth_session: p2 } = await this.myAccountApi.connectAccount({ connection: o2, scopes: i2, redirect_uri: s2, state: a2, code_challenge: d2, code_challenge_method: "S256", authorization_params: r2 });
...
var Auth0Provider = function(opts) {
  ...
  var client = (0, import_react.useState)(function() {
    return new Ue(toAuth0ClientOptions(clientOpts));
  })[0];
