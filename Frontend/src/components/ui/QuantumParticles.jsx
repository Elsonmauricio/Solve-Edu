...
// Define o componente QuantumParticles, que gera um efeito de partículas quânticas animadas.
export const QuantumParticles = () => {
  ...
  return (
    ...
    <div className="quantum-particles absolute inset-0 overflow-hidden">
      ...
      {particles.map((particle) => (
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(circle, rgba(59, 130, 246, 0.9) 0%, rgba(96, 165, 250, 0.7) 40%, rgba(147, 197, 253, 0.5) 70%, transparent 100%)',
