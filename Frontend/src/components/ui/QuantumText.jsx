...
// Define o componente QuantumText, que aplica um efeito de texto "quântico" animado.
// Aceita propriedades como 'children' (o texto a ser exibido), 'className' e 'size'.
export const QuantumText = ({ 
  children, 
  className = '',
  ...
  return (
    <motion.span
      ...
      className={`
        quantum-text // Classe base para o estilo do texto.
        ${sizeClasses[size]} // Classe de tamanho baseada na propriedade 'size'.
        ${className} // Classes personalizadas passadas via props.
        animate-quantum-text-flow // Classe que pode conter animações CSS adicionais.
      `}
