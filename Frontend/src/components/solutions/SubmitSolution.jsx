...
import { ArrowLeft, Plus, X, Upload, Github, Link as LinkIcon } from 'lucide-react';

const SubmitSolution = () => {
  const { id } = useParams();
  const { problems, dispatch } = useApp();
  ...
  const handleSubmit = (e) => {
    ...
    const newSolution = {
      ...
      student: "João Silva", // This would come from auth context
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <p className="text-gray-600 mb-4">{problem.company}</p>
