...
const SolutionList: React.FC<SolutionListProps> = ({ solutions, loading, error }) => {
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            Para: Desafio #{solution.problemId}
                          </p>
                        </div>
                      </>
                    )}
              ...
              <div className="p-6 mt-auto bg-gray-50 border-t border-gray-100">
                <div className="flex items-center justify-between text-sm text-gray-600 mb-4">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span>{solution.submittedAt ? new Date(solution.submittedAt).toLocaleDateString() : 'Data indefinida'}</span>
                  </div>
                </div>
