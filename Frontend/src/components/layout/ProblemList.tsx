...
const ProblemList: React.FC<ProblemListProps> = ({ problems, loading, error }) => {
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 line-clamp-1">
                      {typeof problem.company === 'string' ? problem.company : problem.company?.companyName || "Empresa Confidencial"}
                    </h3>
            ...
            <div className="p-6 mt-auto bg-gray-50 border-t border-gray-100">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-gray-500 text-sm">
                  ...
                  {problem.deadline ? new Date(problem.deadline).toLocaleDateString() : 'Sem limite'}
                </div>
              </div>
