...
export const InitialInterface = ({ onInterfaceChange }) => {
  // Dados para os cartões que representam cada tipo de interface de usuário.
  const interfaceCards = [
    {
      emoji: '🎓',
      title: 'Para Estudantes',
      description: 'Dashboard personalizado com desafios recomendados e acompanhamento quântico de projetos',
      color: 'blue'
    },
    {
      emoji: '🏢', 
      title: 'Para Empresas',
      description: 'Portal para publicar desafios, gerir candidaturas e acompanhar projetos revolucionários',
      color: 'green'
    },
    {
      emoji: '🏫',
      title: 'Para Escolas', 
      description: 'Gestão de estudantes, acompanhamento de PAPs e parcerias empresariais avançadas',
      color: 'teal'
    },
    {
      emoji: '⚙️',
      title: 'Para Admins',
      description: 'Painel completo com métricas quânticas, gestão de utilizadores e monitorização',
      color: 'gray'
    }
  ];
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 lg:px-8 py-24 bg-gradient-to-b from-white to-gray-50">
      ...
      >
        ...
        >
          Escolha a sua Interface Quântica
        </motion.h3>
