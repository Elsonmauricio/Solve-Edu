...
// Define o hook customizado 'useGlitchEffect'.
...
export const useGlitchEffect = () => {
  ...
  useEffect(() => {
    ...
    console.log('✨ Efeitos de glitch ativados!');
    ...
    const interval = setInterval(() => {
      // Seleciona todos os elementos no documento que têm a classe '.gradient-text'.
